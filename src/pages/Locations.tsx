    ...
    <AppLayout>
      ...
      <main className="pt-6">
        ...
        <section className="py-12 md:py-16 relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-[#A1A1AA] max-w-3xl mx-auto mb-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                ...
                <Card variant="elevated" padding="lg" className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-white mb-2">Practice Location</h3>
                      <address className="text-[#A1A1AA] not-italic leading-relaxed">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-4">
                        <h3 className="text-xl font-semibold text-white">Practice Hours</h3>
                        <Badge 
                      ...
                      <div className="space-y-2">
                        {hoursArray.map(({ day, hours }) => (
                          ...
                          >
                            ...
                            <span className={`text-sm ${hours === 'Closed' ? 'text-[#71717A]' : 'text-[#A1A1AA]'}`}>
                              {hours}
                            </span>
                          </div>
                        ))}
              ...
              >
                <Card variant="elevated" padding="sm" className="overflow-hidden">
                  <div className="aspect-square md:aspect-[4/3] w-full bg-white/5 rounded-lg overflow-hidden relative">
                    {!isMapLoaded && (
                      <div className="absolute inset-0 flex items-center justify-center bg-[#1C1C24]">
                        <div className="text-center">
                          <MapPin className="w-12 h-12 text-[#71717A] mx-auto mb-3" />
                          <p className="text-[#A1A1AA] font-medium">Loading Map...</p>
                        </div>
                      </div>
                    )}
                    <iframe
                  ...
                  <div className="mt-4 p-4 bg-[#1C1C24] rounded-xl border border-white/5">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-semibold text-white">Free Parking Available</p>
                        <p className="text-sm text-[#A1A1AA]">Convenient access from Lafayette Avenue</p>
                      </div>
                      <button
                        onClick={() => window.open(`https://maps.google.com/?q=${encodeURIComponent(practiceInfo.address.full)}`, '_blank')}
        ...
        {physicians && physicians.length > 0 && (
          <section className="py-12 md:py-16 bg-[#0F0F14]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                {physicians.map((physician, index) => (
                  ...
                  >
                    <Card variant="elevated" padding="lg" hover className="text-center h-full">
                      <div className="w-20 h-20 bg-gradient-to-br from-purple-700 to-fuchsia-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-soft">
                      ...
                      <div className="flex items-center justify-center gap-1 mt-4">
                        ...
                        <span className="text-sm text-[#A1A1AA] ml-2">Excellent Reviews</span>
                      </div>
                    </Card>
                  </motion.div>
                ))}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                { icon: Shield, number: "15+", label: "Years Experience", color: "bg-[#6D28D9]" }
              ].map((stat, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
